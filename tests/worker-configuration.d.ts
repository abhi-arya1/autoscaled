/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d2a846da6a3f0b4145a98ce3d0a981f)
// Runtime types generated with workerd@1.20251213.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MyContainer" | "MyAutoscaler";
	}
	interface Env {
		MY_CONTAINER: DurableObjectNamespace<import("./src/index").MyContainer>;
		AUTOSCALER: DurableObjectNamespace<import("./src/index").MyAutoscaler>;
	}
}
